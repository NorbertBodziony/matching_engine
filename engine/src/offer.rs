...
pub struct OfferSide {
    pub orders: PriorityQueue<Order, i128>,
    pub counter: u128,
}
...
impl OfferSide {
    ...
    pub fn add_order(&mut self, amount: u128, price: u128, filled: u128) {
        self.orders.push(
            Order::new(amount, price, filled, self.counter),
            -(price as i128),
        );
        self.counter += 1;
    }
